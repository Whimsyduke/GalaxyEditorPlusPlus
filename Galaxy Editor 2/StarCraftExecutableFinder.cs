...
namespace Galaxy_Editor_2
{
    ...
    class StarCraftExecutableFinder
    {
        ...
        public static string findExecutable()
        {
            ...
            {
                MessageBox.Show(LocRM.GetString("SCEF_MissData_Text"), LocRM.GetString("SCEF_MissData"));

                if (dialog.ShowDialog() == DialogResult.Cancel)
                {
                    MessageBox.Show(LocRM.GetString("SCEF_MissData_NotLoad_Text"), LocRM.GetString("SCEF_MissData"));
                    return null;
                }
