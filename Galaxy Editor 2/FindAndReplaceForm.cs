...
namespace Galaxy_Editor_2
{
    public partial class FindAndReplaceForm : AutoSizeForm
    {
        ...
        private ResourceManager LocRM = new ResourceManager("Galaxy_Editor_2.FindAndReplaceForm", typeof(FindAndReplaceForm).Assembly);
        ...
        public void ResetPos()
        {
            if (Form1.Form.CurrentOpenFile == null)
            {
                ...
                {
                    MessageBox.Show(this, LocRM.GetString("NoSearchFile.Text"));
                    Close();
                }
        ...
        private void BTNFind_Click(object sender, EventArgs e)
        {
            if (!Next(true))
            {
                MessageBox.Show(this, LocRM.GetString("NoFind.Text"), LocRM.GetString("SearchEnd.Text"));
            }
        }
        ...
        private void BTNReplaceAll_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(this, LocRM.GetString("Replaced.Text") + count + LocRM.GetString("Occurences.Text"), LocRM.GetString("SearchEnd.Text"));
        }
