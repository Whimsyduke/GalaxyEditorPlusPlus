...
namespace Galaxy_Editor_2
{
    ...
    {
        private ResourceManager LocRM = new ResourceManager("Galaxy_Editor_2.Form1", typeof(Form1).Assembly);
        public bool F_Disposed;
            ...
            private set
            {
                ...
                if (value != null && ProjectProperties.CurrentProjectPropperties.LoadSaveScriptToMap)
                {
                    ...
                    else if (Directory.Exists(ProjectProperties.CurrentProjectPropperties.MapPath))
                    {
                        ...
                        if (!codeDir.Exists)
                        {
                            MessageBox.Show(this, LocRM.GetString("Text1.Text"), LocRM.GetString("Error.Text"));
        ...
        internal void RebuildProjectView()
        {
            ...
            {//List of files in project
                ...
                if (dir.FixConflicts(".galaxy", "BankList.xml"))
                    ProjectProperties.CurrentProjectPropperties.Save();
...
//Make file, and open it
        ...
        private void projectView_DragCompleteValid(object sender, DragCompletionValidEventArgs e)
        {
            ...
            {
                MessageBox.Show(this, LocRM.GetString("Text20.Text"), LocRM.GetString("Error.Text"));
                e.Cancel = true;
                return;
            }
        ...
        private void projectView_AfterLabelEdit(object sender, NodeLabelEditEventArgs e)
        {
            ...
            if (openProjectDir == null)
            {
                ...
                {
                    MessageBox.Show(this, LocRM.GetString("Text22.Text"),
                                    LocRM.GetString("Error.Text"));
                    e.CancelEdit = true;
                    return;
                }
                if (target.Exists)
                {
                    MessageBox.Show(this, LocRM.GetString("Text23.Text"),
                                    LocRM.GetString("Error.Text"));
                    e.CancelEdit = true;
                    return;
                }
            ...
            else
            {
                ...
                foreach (char c in Path.GetInvalidFileNameChars())
                {
                    ...
                    {
                        string errText = LocRM.GetString("Text24.Text");
                        bool first = true;
                ...
                if (item is FolderItem)
                {
                    ...
                    if (target.Parent.FullName.Trim('\\', '/') != projectDir.FullName.Trim('\\', '/'))
                    {
                        MessageBox.Show(this, LocRM.GetString("Text26.Text"),
                                        LocRM.GetString("Error.Text"));
                        e.CancelEdit = true;
                        return;
                    }
                ...
                if (!success)
                {
                    MessageBox.Show(this, LocRM.GetString("Text27.Text"),
                                    LocRM.GetString("Error.Text"));
                    e.CancelEdit = true;
                    return;
                }
        ...
        private void CloseProject(out bool cancel)
        {
            ...
            foreach (OpenFileData openFile in openFiles)
            {
                if (openFile.Changed)
                {
                    ...
                    {
                        result = MessageBox.Show(this, LocRM.GetString("Text30.Text"), 
                                                 LocRM.GetString("Text29.Text"),
                                                 MessageBoxButtons.YesNoCancel);
                        if (result == DialogResult.Cancel)
                        {
            ...
            if (result == DialogResult.Yes || result == DialogResult.None)
            {
                ...
                {
                    result = MessageBox.Show(this, LocRM.GetString("Text31.Text"),
                                             LocRM.GetString("Text29.Text"),
                                             MessageBoxButtons.YesNoCancel);
                    if (result != DialogResult.Yes)
                    {
        ...
        private void messageView_MouseDoubleClick(TreeViewDragDrop sender, MouseEventArgs e, ref bool handled)
        {
            ...
            if (messageView.SelectedNode is ErrorCollection.Error)
            {
                ...
                if (!file.Exists)
                {
                    ...
                    if (!file.Exists)
                    {
                        MessageBox.Show(this, LocRM.GetString("Text32.Text"), LocRM.GetString("Error.Text"));
                        return;
                    }
                    if (error.pos.Line == -1)
                    {
                        MessageBox.Show(this, LocRM.GetString("Text33.Text"), LocRM.GetString("Error.Text"));
                        return;
                    }
                    ...
                    MessageBox.Show(this, LocRM.GetString("Text34.Text"), LocRM.GetString("Error.Text"));
                }
                if (error.pos.Line == -1)
                {
                    MessageBox.Show(this, LocRM.GetString("Text33.Text"), LocRM.GetString("Error.Text"));
        ...
        {
            F_AboutForm = new AboutForm();
            F_AboutForm.Show(this);
        }
        ...
        private void compiler_CompilationSuccessfull()
        {
            ...
            if (!rootFile.Exists)
            {
                MessageBox.Show(this, LocRM.GetString("Text36.Text"),
                                LocRM.GetString("Text37.Text"));
            }
            else
            {
                ...
                if (mapFile == null)
                {
                    MessageBox.Show(this, LocRM.GetString("Text38.Text"), LocRM.GetString("Text39.Text"));
                ...
                if (saveCompiledMap)
                {
                    ...
                    if (outputMap == null)
                    {
                        MessageBox.Show(this, LocRM.GetString("Text40.Text"), LocRM.GetString("Text39.Text"));
                        new ProjectSettingsForm().ShowDialog(this);
                        if (ProjectProperties.CurrentProjectPropperties.OutputMapPath != "")
                        {
                            /*//if (File.Exists(ProjectProperties.CurrentProjectPropperties.OutputMapPath) ||
                    ...
                    {
                        MessageBox.Show(this, LocRM.GetString("Text41.Text"), LocRM.GetString("Error.Text"));
                        return;
                    }
                    ...
                    if (!Options.Compiler.NeverAskToRunSavedMap && sc2Exe != null && sc2Exe.Exists && MessageBox.Show(this,
                                        LocRM.GetString("Text42.Text")
                                        , LocRM.GetString("Save.Text"), MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                ...
                {
                    MessageBox.Show(this,
                                        LocRM.GetString("Text43.Text"), LocRM.GetString("Error"));
                    return;
                }
        ...
        {
            F_SearcDefinitionsForm = new SearcDefinitionsForm();
            F_SearcDefinitionsForm.Show();
        }
        ...
        private void ObjectBrowserCatagory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (selectedItem)
            {
                case MapObjectsManager.ObjectType.Units:
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightType.Text"));
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightOwner.Text"));
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightID.Text"));
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightPosition.Text"));
                    break;
                case MapObjectsManager.ObjectType.Regions:
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightName.Text"), 150);
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightID.Text"), 25);
                    break;
                case MapObjectsManager.ObjectType.Points:
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightName.Text"), 150);
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightType.Text"), 150);
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightID.Text"), 25);
                    ObjectBrowserList.Columns.Add(LocRM.GetString("RightPosition.Text"), 150);
                    break;
        ...
        {
            F_Change_log_form = new Change_log_form();
            F_Change_log_form.Show();
        }
       ...
       private void chineseSimpleToolStripMenuItem_Click(object sender, EventArgs e)
       {
           ...
           Language = "zh-Hans";
           Options.Editor.LanguageSet = Language;
           foreach (ToolStripMenuItem subItem in this.LanguageToolStripMenuItem.DropDownItems)
           {
               subItem.Checked = false;
           }
       ...
       public Change_log_form F_Change_log_form;
       ...
       private void ApplyResource()
       {
           ...
           foreach (ToolStripMenuItem item in this.menuStrip1.Items)
           {
               ...
               foreach (ToolStripMenuItem subItem in item.DropDownItems)
               {
                   ...
                   {
                       res.ApplyResources(subSubItem, subSubItem.Name);
                   }
               }
           }

           //Other
           res.ApplyResources(tabPage2, tabPage2.Name);
           res.ApplyResources(mapObjectBrowserPage, mapObjectBrowserPage.Name);

           res.ApplyResources(CBShowErrors, CBShowErrors.Name);
           res.ApplyResources(CBShowWarnings, CBShowWarnings.Name);

           res.ApplyResources(compilerStatusText, compilerStatusText.Name);

           res.ApplyResources(RightClickCut, RightClickCut.Name);
           res.ApplyResources(RightClickCopy, RightClickCopy.Name);
           res.ApplyResources(RightClickPaste, RightClickPaste.Name);
           res.ApplyResources(RightClickFind, RightClickFind.Name);
           res.ApplyResources(toolStripMenuItem1, toolStripMenuItem1.Name);
           res.ApplyResources(TSInsertConstructor, TSInsertConstructor.Name);
           res.ApplyResources(goToDeclarationToolStripMenuItem, goToDeclarationToolStripMenuItem.Name);

           res.ApplyResources(TBNewProject, TBNewProject.Name);
           res.ApplyResources(TBNewFile, TBNewFile.Name);
           res.ApplyResources(TBNewFolder, TBNewFolder.Name);
           res.ApplyResources(TBDelete, TBDelete.Name);
           res.ApplyResources(TBSave, TBSave.Name);
           res.ApplyResources(TBSaveAll, TBSaveAll.Name);
           res.ApplyResources(TBCut, TBCut.Name);
           res.ApplyResources(TBCopy, TBCopy.Name);
           res.ApplyResources(TBPaste, TBPaste.Name);
           res.ApplyResources(TBUndo, TBUndo.Name);
           res.ApplyResources(TBRedo, TBRedo.Name);
           res.ApplyResources(TBRun, TBRun.Name);
           res.ApplyResources(TBFind, TBFind.Name);
           res.ApplyResources(TBRefreshObjectList, TBRefreshObjectList.Name);

           res.ApplyResources(newFileToolStripMenuItem, newFileToolStripMenuItem.Name);
           res.ApplyResources(newDialogToolStripMenuItem, newDialogToolStripMenuItem.Name);
           res.ApplyResources(newFolderToolStripMenuItem, newFolderToolStripMenuItem.Name);
           res.ApplyResources(removeToolStripMenuItem, removeToolStripMenuItem.Name);
           res.ApplyResources(renameToolStripMenuItem, renameToolStripMenuItem.Name);
           res.ApplyResources(openInExploreToolStripMenuItem, openInExploreToolStripMenuItem.Name);
           res.ApplyResources(activateToolStripMenuItem, activateToolStripMenuItem.Name);
           res.ApplyResources(newProjectToolStripMenuItem, newProjectToolStripMenuItem.Name);
           res.ApplyResources(deleteProjectToolStripMenuItem, deleteProjectToolStripMenuItem.Name);

           res.ApplyResources(ObjectBrowserList, ObjectBrowserList.Name);
           res.ApplyResources(BTNUnitFilterInsert, BTNUnitFilterInsert.Name);
           res.ApplyResources(BTNUnitFilterReset, BTNUnitFilterReset.Name);
           res.ApplyResources(CBUnitFilterCompress, CBUnitFilterCompress.Name);

           ObjectBrowserCatagory_SelectedIndexChanged(null, null);

           //Caption
           //res.ApplyResources(this, "$this");
           this.Text = LocRM.GetString("$this.Text");

           //Other Form
           if (F_AboutForm != null)
           {
               F_AboutForm.ApplyResource();
           }
           if (F_SearcDefinitionsForm != null)
           {
               F_SearcDefinitionsForm.ApplyResource();
           }
           if (F_Change_log_form != null)
           {
               F_Change_log_form.ApplyResource();
           }
