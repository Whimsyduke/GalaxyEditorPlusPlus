...
namespace Galaxy_Editor_2.Dialog_Creator
{
    class TextureLoader
    {
        static private ResourceManager LocRM = new ResourceManager("Galaxy_Editor_2.Language", typeof(Language).Assembly);
        private static readonly Dictionary<string, LoadedTexture> LoadedTextures = new Dictionary<string, LoadedTexture>();
        ...
        private static void GetAssetFiles(string directory, List<string> assets)
        {
