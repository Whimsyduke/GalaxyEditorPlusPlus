    ...
    partial class Form1 : Form, IMessageFilter
    {
        ...
        public DirectoryInfo openProjectDir
        {
            ...
            private set
            {
                ...
                ProjectProperties.SetProject(value);
        ...
        public FolderItem openProjectSrcDir
        {
            get
            {
                ...
                if (ProjectProperties.CurrentProjectPropperties.SrcFolder == null)
                    ProjectProperties.CurrentProjectPropperties.SrcFolder = new FolderItem(null, openProjectDir.CreateSubdirectory("src"));
        ...
        public FolderItem openProjectOutputDir
        {
            get
            {
                ...
                if (ProjectProperties.CurrentProjectPropperties.OutputFolder == null)
                    ProjectProperties.CurrentProjectPropperties.OutputFolder = new FolderItem(null, openProjectDir.CreateSubdirectory("output"));
        ...
        private void projectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            openProjectDir = projectDir.CreateSubdirectory(projectName);
            openProjectDir.CreateSubdirectory("src");
        ...
        private void projectView_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {//Open selected project
                ...
                if (node == null || node.Tag == null)
                    return;
                openProjectDir = (DirectoryInfo) node.Tag;
        ...
        internal void RebuildProjectView()
        {
            ...
            {//List of files in project
                ...
                dir.GUINode = new TreeNode(openProjectDir.Name + "   ");
        ...
        private void MakeNewDialog()
        {
            ...
            {//Make file, and open it
                ...
                item.DesignerGUINode = new TreeNode(name.Substring(0, name.LastIndexOf(".Dialog")) + ".Designer.galaxy++");
                item.DesignerGUINode.SelectedImageIndex = item.DesignerGUINode.ImageIndex = 2;
                item.DesignerGUINode.Tag = item;
                item.GUINode.Nodes.Add(item.DesignerGUINode);
        ...
        private void MakeNewFile()
        {
            ...
            {//Make file, and open it
                ...
                FileItem newFile = new FileItem(parentFolder, fileInfo);
        ...
        public void OpenFile(DialogItem file, TreeNode nodePressed)
        {
            ...
            else if (file.DesignerGUINode == nodePressed)
            {
                ...
                file.OpenFileData.DesignerTabPage = new FATabStripItem(file.Text.Substring(0, file.Text.LastIndexOf(".Dialog")) + ".galaxy++", null);
        ...
        private void newFolderToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FolderItem newFolder = new FolderItem(parentFolder, parentFolder.Dir.CreateSubdirectory(name));
        ...
        private void compileToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           /* foreach (OpenFileData openFile in openFiles)
            ...
            if (Directory.Exists(openProjectOutputDir.Dir.FullName))
            {
                ...
                openProjectOutputDir.Dir = new DirectoryInfo(openProjectOutputDir.Dir.FullName);
            }
        ...
        private void Form1_Resize(object sender, EventArgs e)
        {
            ...
            PBGurilande.Location = new Point(helpToolStripMenuItem.Bounds.X + helpToolStripMenuItem.Bounds.Width, PBGurilande.Location.Y);
            PBGurilande.Width = ClientSize.Width - PBGurilande.Location.X;
            PBGurilande.Invalidate();
        }
        ...
        private void TSInsertConstructor_Click(object sender, EventArgs e)
        {
            ...
            TextPoint currentPos = CurrentOpenFile.OpenFile.Editor.caret.GetPosition(true);
            foreach (SourceFileContents file in compiler.ParsedSourceFiles)
            {
                if (file.Item == CurrentOpenFile)
                {
                    foreach (StructDescription s in file.Structs)
                    {
            ...
            CurrentOpenFile.OpenFile.Editor.InsertAndStyle(lastFieldPos, insert);
        }
