...
namespace Galaxy_Editor_2
{
    public partial class ExceptionForm : AutoSizeForm
    {
        ...
        private ResourceManager LocRM = new ResourceManager("Galaxy_Editor_2.ExceptionForm", typeof(ExceptionForm).Assembly);
        ...
        private void BTNSend_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(LocRM.GetString("NotErrorReportSend.Text"));
