...
namespace Galaxy_Editor_2
{
    ...
    {
        private ResourceManager LocRM = new ResourceManager("Galaxy_Editor_2.GotoLineForm", typeof(GotoLineForm).Assembly);
        ...
        public GotoLineForm(int currentLine, int lineCount)
        {
            ...
            InitializeComponent();
            label1.Text = LocRM.GetString("LineNum.Text") + lineCount + ")";
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (valid)
                ...
                toolTip1.SetToolTip(textBox1, LocRM.GetString("AbleLine.Text") + lineCount + "]");
        }
