...
namespace Galaxy_Editor_2
{
    ...
    {
        private ResourceManager LocRM = new ResourceManager("Galaxy_Editor_2.OptionsForm", typeof(OptionsForm).Assembly);
        public OptionsForm()
        {
            InitializeComponent();
        ...
        private void cbEditorReadOnlyOut_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (!cbEditorReadOnlyOut.Checked)
                MessageBox.Show(LocRM.GetString("ChangeWarning.Text"),
                                LocRM.GetString("Warning.Text"));
        }
