...
namespace Galaxy_Editor_2
{
    public partial class SearcDefinitionsForm : AutoSizeForm
    {
        ...
        public void ApplyResource()
        {
            ...
            System.ComponentModel.ComponentResourceManager res = new ComponentResourceManager(typeof(SearcDefinitionsForm));

            res.ApplyResources(groupBox2, groupBox2.Name);
            res.ApplyResources(CB_Method, CB_Method.Name);
            res.ApplyResources(CB_Field, CB_Field.Name);
            res.ApplyResources(CB_Type, CB_Type.Name);
            ...
            res.ApplyResources(GB_Type, GB_Type.Name);
            res.ApplyResources(GB_Params, GB_Params.Name);
            res.ApplyResources(label5, label5.Name);
            res.ApplyResources(BTN_AddParameter, BTN_AddParameter.Name);
            res.ApplyResources(BTN_RemoveParameters, BTN_RemoveParameters.Name);
