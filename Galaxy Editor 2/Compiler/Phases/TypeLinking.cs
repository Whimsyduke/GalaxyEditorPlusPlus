    ...
    class TypeLinking : DepthFirstAdapter
    {
        ...
        */
        ...
        private void CheckValidConstExp(PExp exp)
        {
            ...
            errors.Add(new ErrorCollection.Error(integerConstantToken, currentSourceFile, LocRM.GetString("ErrorText168"), false), true);
        ...
        public static ErrorCollection.Error GetErrorPath(List<Node> nodes)
        {
            if (nodes.Count == 1)
            {
                ...
                return new ErrorCollection.Error(token, LocRM.GetString("ErrorText100"));
            }
            else
            {
                ...
                return new ErrorCollection.Error(token, LocRM.GetString("ErrorText100"), false, path.ToArray());
            }
        }
